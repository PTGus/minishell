...
#    Updated: 2025/07/08 10:05:19 by gumendes         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_UTILS	=	$(addprefix utils/, cd_utils.c central_utils.c env_utils.c exec_utils.c export_utils.c export_utils2.c list_utils.c pipe_utils.c redir_utils.c utils.c)
