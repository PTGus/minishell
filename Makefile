...
#    Updated: 2025/07/28 15:26:38 by gumendes         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_UTILS	=	$(addprefix utils/, cd_utils.c central_utils.c env_utils.c env_utils2.c exec_utils.c exec_utils2.c exec_utils3.c \
				exit_utils.c export_utils.c export_utils2.c gnl.c list_utils.c pipe_utils.c redir_utils.c rl_utils.c utils.c)
